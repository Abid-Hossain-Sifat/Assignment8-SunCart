      ...
      <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
        ...
        <div className="relative px-6 pb-8">
          ...
          <div className="absolute -top-14 left-6">
            <div className="h-28 w-28 rounded-full border-4 border-white bg-white shadow-lg overflow-hidden flex items-center justify-center">
              {user.image && !imageError ? (
                ...
                <div className="h-full w-full bg-[#008080] flex items-center justify-center text-4xl font-bold text-white uppercase">
          ...
          <div className="mt-10 space-y-5">
            ...
            <div className="flex justify-end pt-1">
              <Link href="/my-profile/update-profile">
                <button className="flex items-center gap-2 bg-[#008080] hover:bg-[#0f766e] text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-colors shadow-sm hover:shadow-md">
